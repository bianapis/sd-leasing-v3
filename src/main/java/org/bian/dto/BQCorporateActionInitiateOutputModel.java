...
/**
 * BQCorporateActionInitiateOutputModel
 */
public class BQCorporateActionInitiateOutputModel   {
  private String corporateActionInstanceReference = null;

  private String corporateActionInitiateActionReference = null;

  private Object corporateActionInitiateActionRecord = null;

  private String corporateActionInstanceStatus = null;
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: Reference to the Corporate Action instance 
   * @return corporateActionInstanceReference
  **/

  public String getCorporateActionInstanceReference() {
    return corporateActionInstanceReference;
  }

  public void setCorporateActionInstanceReference(String corporateActionInstanceReference) {
    this.corporateActionInstanceReference = corporateActionInstanceReference;
  }


  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: Reference to an Initiate service call 
   * @return corporateActionInitiateActionReference
  **/

  public String getCorporateActionInitiateActionReference() {
    return corporateActionInitiateActionReference;
  }

  public void setCorporateActionInitiateActionReference(String corporateActionInitiateActionReference) {
    this.corporateActionInitiateActionReference = corporateActionInitiateActionReference;
  }
  ...
  **/
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Text  general-info: The status of the Corporate Action instance (e.g. initialised, pending, active) 
   * @return corporateActionInstanceStatus
  **/

  public String getCorporateActionInstanceStatus() {
    return corporateActionInstanceStatus;
  }

  public void setCorporateActionInstanceStatus(String corporateActionInstanceStatus) {
    this.corporateActionInstanceStatus = corporateActionInstanceStatus;
  }
