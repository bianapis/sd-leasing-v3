...
/**
 * BQFeesInitiateOutputModel
 */
public class BQFeesInitiateOutputModel   {
  private String feesInstanceReference = null;

  private String feesInitiateActionReference = null;
  ...
  **/
   ...
   * @return feesInitiateActionReference
  **/

  public String getFeesInitiateActionReference() {
    return feesInitiateActionReference;
  }

  public void setFeesInitiateActionReference(String feesInitiateActionReference) {
    this.feesInitiateActionReference = feesInitiateActionReference;
  }
  ...
  **/
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Text  general-info: The status of the Fees instance (e.g. initialised, pending, active) 
